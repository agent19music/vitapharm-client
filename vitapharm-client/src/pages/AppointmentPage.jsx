...
const appointmentOptions = [
  ...
  { label: 'Facial Treatments - Chemical Peel (10,000)', value: 'facial_treatment_chemical_peel_10,000' },
  { label: 'Facial Treatments - Hydrafacial (15,000)', value: 'facial_treatment_hydrafacial_15,000' },
  { label: 'Facial Treatments - Timeless Facial Treatment (6,000)', value: 'facial_treatment_timeless_6,000' },
  { label: 'Facial Treatments - Deep Exfoliating (8,000)', value: 'facial_treatment_deep_exfoliating_8,000' },
  { label: 'Waxing - Underarm (700)', value: 'waxing_underarm_700' },
  { label: 'Waxing - Bikini (2,000)', value: 'waxing_bikini_2,000' },
  { label: 'Waxing - Double Treatment (14,000)', value: 'waxing_double_treatment_14,000' },
  { label: 'Body Massage - Swedish (5,000)', value: 'body_massage_swedish_5,000' },
  { label: 'Body Massage - Soft Tissue (from 4,000)', value: 'body_massage_soft_tissue_from_4,000' },
  { label: 'Body Massage - Deep Tissue (from 5,000)', value: 'body_massage_deep_tissue_from_5,000' },
  { label: 'Dermaplanning (4,000)', value: 'dermaplanning_4,000' },
  { label: 'Microneedling (18,000)', value: 'microneedling_18,000' },
  { label: 'Glutathione IV (25,000)', value: 'glutathione_iv_25,000' },
  { label: 'Skin Tag Removal (from 7,000)', value: 'skin_tag_removal_from_7,000' },
