...
export default function SocialVideos() {
  return (
    <>
    <div className="flex flex-wrap justify-center gap-4 p-4 rounded-none desktop-reels">
      {[
     ...
     <div className="flex flex-wrap justify-center gap-4 p-4 rounded-none mobile-reels">
      {[
        "https://www.instagram.com/p/C6OlMFGq0Ht/",
        "https://www.instagram.com/p/C53AOV9MMEs/",
      ].map((url) => (
