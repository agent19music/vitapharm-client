    ...
    return (
        ...
        <div className="flex flex-col md:flex-row justify-center m-auto w-full py-12 sm:py-16 min-h-screen">
            <div className="flex w-full max-w-6xl px-6 h-full flex-col md:flex-row">
                {/* Image Thumbnails */}
                <div className="order-2 md:order-1 w-full md:w-1/12 flex md:flex-col items-center space-x-3 md:space-y-3">
                    {loading ? (
                ...
                {/* Selected Image */}
                <div className="order-1 md:order-2 w-full md:w-4/12 flex items-center justify-center mb-6 md:mb-0">
                    {loading ? (
