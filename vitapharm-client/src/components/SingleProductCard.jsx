...
<div>
    <Header />
    <div className="flex justify-center m-auto w-full py-12 sm:py-16 bg-gray-600 min-h-screen">
        <div className="flex w-full max-w-6xl px-6 h-full space-x-8">
            {/* Image Thumbnails */}
            <div className="w-1/12 flex flex-col items-center space-y-3 bg-cyan-500">
            ...
            {/* Selected Image */}
            <div className="w-4/12 flex items-center justify-center bg-lime-400">
                <img
            ...
            {/* Product Details */}
            <div className="w-7/12 bg-orange-500 p-8">
