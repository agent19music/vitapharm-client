...
const ProductCard = ({ product, addToCart }) => {
  ...
  <div className="search-results-product-card group relative border-zinc-100/30  lg:w-72  flex flex-col self-center overflow-hidden border shadow-md lg:max-h-96 sm:ml-10">
      ...
      <button onClick={()=>addToCart(product.id)} className="flex h-10 rounded-none w-10 items-center justify-center bg-gray-900 text-white transition hover:bg-brown-custom hover:text-white">
      ...
      <div className="mt-4 px-5 pb-5">
        ...
        <div className="mt-2 mb-5 flex items-center justify-between">
          <p>
            <span className="text-3xl font-futura text-black">{price !== null ? price : "N/A"}</span>
